...
import { createProjectSchema, listProjectsQuery, projectIdParams, updateProjectSchema, } from './projects.validation.js';
...
projectRoutes.patch('/:id', requireAuth, requireRole('entrepreneur', 'admin'), validate({ params: projectIdParams, body: updateProjectSchema }), controller.updateProject);
